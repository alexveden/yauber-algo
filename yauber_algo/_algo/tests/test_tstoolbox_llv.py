...
class LLVTestCase(unittest.TestCase):
    def test_llv(self):
        ...
        from yauber_algo.algo import llv
        ...
        with sc.SanityChecker(algo) as s:
            ...
            s.check_series(
                pd.Series(array([nan, nan, 1, 2, 3, 4, 5])),
                func,
                (
            ...
            s.check_dtype_float(
                array([nan, nan, 1, 2, 3, 4, 5], dtype=np.float),
                func,
                (
            ...
            s.check_dtype_bool(
                array([nan, nan, 0, 0, 1, 0, 0], dtype=np.float),
                func,
                (
                    array([False, False, True, True, True, False, True], dtype=np.bool),
                    3
                ),
            )
